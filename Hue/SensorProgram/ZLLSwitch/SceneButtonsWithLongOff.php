...
final class SceneButtonsWithLongOff implements ProgramInterface
{
    ...
    {
        return 'Scene buttons with long off';
    }

    public function description(): string
    {
        return 'Same as Scene buttons, but with extra long press on off to turn all lights off.';
    }
