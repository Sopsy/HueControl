...
final class SceneButtons extends AbstractDimmerSwitchProgram implements Program
{
    public function apply(): void
    {
        ...
        $this->createRulesForOffButton($ruleRepo, $scenes, $switch, $group);
    }
    ...
    private function createRulesForOffButton(RuleRepository $ruleRepo, GroupInterface $scenes, ResourceInterface $switch, ResourceInterface $group): void
    {
